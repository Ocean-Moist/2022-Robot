...
public class BetterAutoForwardDistance extends CommandBase {
    ...
    public BetterAutoForwardDistance(DrivetrainSubsystem drivetrainSubsystem) {
        ...
        TrajectoryConfig config =
                new TrajectoryConfig(
                        Constants.DriveConstants.maxDriveSpeedMetersPerSecond,
                        Constants.DriveConstants.maxDriveAccelerationMetersPerSecondSquared)
