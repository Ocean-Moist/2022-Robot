...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    public DrivetrainSubsystem() {
        ...
        leftEncoder.setDistancePerPulse(wheelDiameter * 0.0254 * Math.PI * driveGearRatio / 2048); // 6-inch wheel,
        // to meters, PI for circumference, gear conversion, 2048 ticks per rotation
        rightEncoder.setDistancePerPulse(wheelDiameter * 0.0254 * Math.PI * driveGearRatio / 2048); // 6-inch wheel,
        // to meters, PI for circumference, gear conversion, 2048 ticks per rotation
    ...
    public void periodic() {
        ...
        //odometry.update(Rotation2d.fromDegrees(gyro.getAngle()), leftEncoder.getDistance(), rightEncoder
        // .getDistance());
    }
